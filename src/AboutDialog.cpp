...
AboutDialog::AboutDialog(QWidget *parent) : QDialog(parent) {
  ...
  text->setText(tr(
      ...
      "<p>This macOS build compiles the editor natively (Apple Silicon and "
      "Intel) and routes the Pawn compiler through CrossOver, since open.mp's "
      "toolchain is Windows-only.</p>"
